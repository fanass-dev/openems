...
public class MeterFroniusTS65A3Impl extends AbstractSunSpecMeter
		implements MeterFroniusTS65A3, ElectricityMeter, ModbusComponent, OpenemsComponent {
...
//			.put(DefaultSunSpecModel.S_204, Priority.LOW) //
			.put(DefaultSunSpecModel.S_213, Priority.LOW) //
			.build();

//	private static final int READ_FROM_MODBUS_BLOCK = 2;
	private static final int READ_FROM_MODBUS_BLOCK = 1;
	private final Logger log = LoggerFactory.getLogger(MeterFroniusTS65A3Impl.class);
	...
	public MeterFroniusTS65A3Impl() {
		super(//
				ACTIVE_MODELS, //
				OpenemsComponent.ChannelId.values(), //
				ModbusComponent.ChannelId.values(), //
				ElectricityMeter.ChannelId.values(), //
				MeterFroniusTS65A3.ChannelId.values() //
		);
	}
