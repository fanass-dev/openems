...
public enum DefaultSunSpecModel implements SunSpecModel {
	...
	public static enum S124_StorCtl_Mod implements SunSpecBitPoint {
		CHARGE(new BitPoint(0, "S124_STOR_CTL_MOD_CHARGE", "CHARGE", AccessMode.READ_WRITE)), //
		DI_S_C_H_A_R_G_E(new BitPoint(1, "S124_STOR_CTL_MOD_DI_S_C_H_A_R_G_E", "DiSCHARGE", AccessMode.READ_WRITE));
	...
	public static enum S160 implements SunSpecPoint {
		...
		MODULE_1_DCEVT(new BitFieldPoint("S160_MODULE_1_DCEVT", "Module 1 Events", "", //
				BitFieldPoint.Type.BITFIELD32, false /* mandatory? */, AccessMode.READ_ONLY, S160_Module1_DCEvt.values())), //
		...
		MODULE_2_DCEVT(new BitFieldPoint("S160_MODULE_2_DCEVT", "Module 2 Events", "", //
				BitFieldPoint.Type.BITFIELD32, false /* mandatory? */, AccessMode.READ_ONLY, S160_Module2_DCEvt.values())), //
		...
		MODULE_3_DCEVT(new BitFieldPoint("S160_MODULE_3_DCEVT", "Module 3 Events", "", //
				BitFieldPoint.Type.BITFIELD32, false /* mandatory? */, AccessMode.READ_ONLY, S160_Module3_DCEvt.values())), //
		...
		MODULE_4_DCEVT(new BitFieldPoint("S160_MODULE_4_DCEVT", "Module 4 Events", "", //
				BitFieldPoint.Type.BITFIELD32, false /* mandatory? */, AccessMode.READ_ONLY, S160_Module4_DCEvt.values()));
	...
	public static enum S160_Module1_DCEvt implements SunSpecBitPoint {
		GROUND_FAULT(new BitPoint(0, "S160_MODULE1_DC_EVT_GROUND_FAULT", "Ground Fault")), //
		INPUT_OVER_VOLTAGE(new BitPoint(1, "S160_MODULE1_DC_EVT_INPUT_OVER_VOLTAGE", "Input Over Voltage")), //
		RESERVED_2(new BitPoint(2, "S160_MODULE1_DC_EVT_RESERVED_2", "Reserved 2")), //
		DC_DISCONNECT(new BitPoint(3, "S160_MODULE1_DC_EVT_DC_DISCONNECT", "DC Disconnect")), //
		RESERVED_4(new BitPoint(4, "S160_MODULE1_DC_EVT_RESERVED_4", "Reserved 4")), //
		CABINET_OPEN(new BitPoint(5, "S160_MODULE1_DC_EVT_CABINET_OPEN", "Cabinet Open")), //
		MANUAL_SHUTDOWN(new BitPoint(6, "S160_MODULE1_DC_EVT_MANUAL_SHUTDOWN", "Manual Shutdown")), //
		OVER_TEMP(new BitPoint(7, "S160_MODULE1_DC_EVT_OVER_TEMP", "Over Temp")), //
		RESERVED_8(new BitPoint(8, "S160_MODULE1_DC_EVT_RESERVED_8", "Reserved 8")), //
		RESERVED_9(new BitPoint(9, "S160_MODULE1_DC_EVT_RESERVED_9", "Reserved 9")), //
		RESERVED_10(new BitPoint(10, "S160_MODULE1_DC_EVT_RESERVED_10", "Reserved 10")), //
		RESERVED_11(new BitPoint(11, "S160_MODULE1_DC_EVT_RESERVED_11", "Reserved 11")), //
		BLOWN_FUSE(new BitPoint(12, "S160_MODULE1_DC_EVT_BLOWN_FUSE", "Blown Fuse")), //
		UNDER_TEMP(new BitPoint(13, "S160_MODULE1_DC_EVT_UNDER_TEMP", "Under Temp")), //
		MEMORY_LOSS(new BitPoint(14, "S160_MODULE1_DC_EVT_MEMORY_LOSS", "Memory Loss")), //
		ARC_DETECTION(new BitPoint(15, "S160_MODULE1_DC_EVT_ARC_DETECTION", "Arc Detection")), //
		RESERVED_16(new BitPoint(16, "S160_MODULE1_DC_EVT_RESERVED_16", "Reserved 16")), //
		RESERVED_17(new BitPoint(17, "S160_MODULE1_DC_EVT_RESERVED_17", "Reserved 17")), //
		RESERVED_18(new BitPoint(18, "S160_MODULE1_DC_EVT_RESERVED_18", "Reserved 18")), //
		RESERVED_19(new BitPoint(19, "S160_MODULE1_DC_EVT_RESERVED_19", "Reserved 19")), //
		TEST_FAILED(new BitPoint(20, "S160_MODULE1_DC_EVT_TEST_FAILED", "Test Failed")), //
		INPUT_UNDER_VOLTAGE(new BitPoint(21, "S160_MODULE1_DC_EVT_INPUT_UNDER_VOLTAGE", "Input Under Voltage")), //
		INPUT_OVER_CURRENT(new BitPoint(22, "S160_MODULE1_DC_EVT_INPUT_OVER_CURRENT", "Input Over Current"));

		private final BitPoint point;

		private S160_Module1_DCEvt(BitPoint point) {
			this.point = point;
		}
	...
	public static enum S160_Module2_DCEvt implements SunSpecBitPoint {
		GROUND_FAULT(new BitPoint(0, "S160_MODULE2_DC_EVT_GROUND_FAULT", "Ground Fault")), //
		INPUT_OVER_VOLTAGE(new BitPoint(1, "S160_MODULE2_DC_EVT_INPUT_OVER_VOLTAGE", "Input Over Voltage")), //
		RESERVED_2(new BitPoint(2, "S160_MODULE2_DC_EVT_RESERVED_2", "Reserved 2")), //
		DC_DISCONNECT(new BitPoint(3, "S160_MODULE2_DC_EVT_DC_DISCONNECT", "DC Disconnect")), //
		RESERVED_4(new BitPoint(4, "S160_MODULE2_DC_EVT_RESERVED_4", "Reserved 4")), //
		CABINET_OPEN(new BitPoint(5, "S160_MODULE2_DC_EVT_CABINET_OPEN", "Cabinet Open")), //
		MANUAL_SHUTDOWN(new BitPoint(6, "S160_MODULE2_DC_EVT_MANUAL_SHUTDOWN", "Manual Shutdown")), //
		OVER_TEMP(new BitPoint(7, "S160_MODULE2_DC_EVT_OVER_TEMP", "Over Temp")), //
		RESERVED_8(new BitPoint(8, "S160_MODULE2_DC_EVT_RESERVED_8", "Reserved 8")), //
		RESERVED_9(new BitPoint(9, "S160_MODULE2_DC_EVT_RESERVED_9", "Reserved 9")), //
		RESERVED_10(new BitPoint(10, "S160_MODULE2_DC_EVT_RESERVED_10", "Reserved 10")), //
		RESERVED_11(new BitPoint(11, "S160_MODULE2_DC_EVT_RESERVED_11", "Reserved 11")), //
		BLOWN_FUSE(new BitPoint(12, "S160_MODULE2_DC_EVT_BLOWN_FUSE", "Blown Fuse")), //
		UNDER_TEMP(new BitPoint(13, "S160_MODULE2_DC_EVT_UNDER_TEMP", "Under Temp")), //
		MEMORY_LOSS(new BitPoint(14, "S160_MODULE2_DC_EVT_MEMORY_LOSS", "Memory Loss")), //
		ARC_DETECTION(new BitPoint(15, "S160_MODULE2_DC_EVT_ARC_DETECTION", "Arc Detection")), //
		RESERVED_16(new BitPoint(16, "S160_MODULE2_DC_EVT_RESERVED_16", "Reserved 16")), //
		RESERVED_17(new BitPoint(17, "S160_MODULE2_DC_EVT_RESERVED_17", "Reserved 17")), //
		RESERVED_18(new BitPoint(18, "S160_MODULE2_DC_EVT_RESERVED_18", "Reserved 18")), //
		RESERVED_19(new BitPoint(19, "S160_MODULE2_DC_EVT_RESERVED_19", "Reserved 19")), //
		TEST_FAILED(new BitPoint(20, "S160_MODULE2_DC_EVT_TEST_FAILED", "Test Failed")), //
		INPUT_UNDER_VOLTAGE(new BitPoint(21, "S160_MODULE2_DC_EVT_INPUT_UNDER_VOLTAGE", "Input Under Voltage")), //
		INPUT_OVER_CURRENT(new BitPoint(22, "S160_MODULE2_DC_EVT_INPUT_OVER_CURRENT", "Input Over Current"));

		private final BitPoint point;

		private S160_Module2_DCEvt(BitPoint point) {
			this.point = point;
		}
	...
	public static enum S160_Module3_DCEvt implements SunSpecBitPoint {
		GROUND_FAULT(new BitPoint(0, "S160_MODULE3_DC_EVT_GROUND_FAULT", "Ground Fault")), //
		INPUT_OVER_VOLTAGE(new BitPoint(1, "S160_MODULE3_DC_EVT_INPUT_OVER_VOLTAGE", "Input Over Voltage")), //
		RESERVED_2(new BitPoint(2, "S160_MODULE3_DC_EVT_RESERVED_2", "Reserved 2")), //
		DC_DISCONNECT(new BitPoint(3, "S160_MODULE3_DC_EVT_DC_DISCONNECT", "DC Disconnect")), //
		RESERVED_4(new BitPoint(4, "S160_MODULE3_DC_EVT_RESERVED_4", "Reserved 4")), //
		CABINET_OPEN(new BitPoint(5, "S160_MODULE3_DC_EVT_CABINET_OPEN", "Cabinet Open")), //
		MANUAL_SHUTDOWN(new BitPoint(6, "S160_MODULE3_DC_EVT_MANUAL_SHUTDOWN", "Manual Shutdown")), //
		OVER_TEMP(new BitPoint(7, "S160_MODULE3_DC_EVT_OVER_TEMP", "Over Temp")), //
		RESERVED_8(new BitPoint(8, "S160_MODULE3_DC_EVT_RESERVED_8", "Reserved 8")), //
		RESERVED_9(new BitPoint(9, "S160_MODULE3_DC_EVT_RESERVED_9", "Reserved 9")), //
		RESERVED_10(new BitPoint(10, "S160_MODULE3_DC_EVT_RESERVED_10", "Reserved 10")), //
		RESERVED_11(new BitPoint(11, "S160_MODULE3_DC_EVT_RESERVED_11", "Reserved 11")), //
		BLOWN_FUSE(new BitPoint(12, "S160_MODULE3_DC_EVT_BLOWN_FUSE", "Blown Fuse")), //
		UNDER_TEMP(new BitPoint(13, "S160_MODULE3_DC_EVT_UNDER_TEMP", "Under Temp")), //
		MEMORY_LOSS(new BitPoint(14, "S160_MODULE3_DC_EVT_MEMORY_LOSS", "Memory Loss")), //
		ARC_DETECTION(new BitPoint(15, "S160_MODULE3_DC_EVT_ARC_DETECTION", "Arc Detection")), //
		RESERVED_16(new BitPoint(16, "S160_MODULE3_DC_EVT_RESERVED_16", "Reserved 16")), //
		RESERVED_17(new BitPoint(17, "S160_MODULE3_DC_EVT_RESERVED_17", "Reserved 17")), //
		RESERVED_18(new BitPoint(18, "S160_MODULE3_DC_EVT_RESERVED_18", "Reserved 18")), //
		RESERVED_19(new BitPoint(19, "S160_MODULE3_DC_EVT_RESERVED_19", "Reserved 19")), //
		TEST_FAILED(new BitPoint(20, "S160_MODULE3_DC_EVT_TEST_FAILED", "Test Failed")), //
		INPUT_UNDER_VOLTAGE(new BitPoint(21, "S160_MODULE3_DC_EVT_INPUT_UNDER_VOLTAGE", "Input Under Voltage")), //
		INPUT_OVER_CURRENT(new BitPoint(22, "S160_MODULE3_DC_EVT_INPUT_OVER_CURRENT", "Input Over Current"));

		private final BitPoint point;

		private S160_Module3_DCEvt(BitPoint point) {
			this.point = point;
		}
	...
	public static enum S160_Module4_DCEvt implements SunSpecBitPoint {
		GROUND_FAULT(new BitPoint(0, "S160_MODULE4_DC_EVT_GROUND_FAULT", "Ground Fault")), //
		INPUT_OVER_VOLTAGE(new BitPoint(1, "S160_MODULE4_DC_EVT_INPUT_OVER_VOLTAGE", "Input Over Voltage")), //
		RESERVED_2(new BitPoint(2, "S160_MODULE4_DC_EVT_RESERVED_2", "Reserved 2")), //
		DC_DISCONNECT(new BitPoint(3, "S160_MODULE4_DC_EVT_DC_DISCONNECT", "DC Disconnect")), //
		RESERVED_4(new BitPoint(4, "S160_MODULE4_DC_EVT_RESERVED_4", "Reserved 4")), //
		CABINET_OPEN(new BitPoint(5, "S160_MODULE4_DC_EVT_CABINET_OPEN", "Cabinet Open")), //
		MANUAL_SHUTDOWN(new BitPoint(6, "S160_MODULE4_DC_EVT_MANUAL_SHUTDOWN", "Manual Shutdown")), //
		OVER_TEMP(new BitPoint(7, "S160_MODULE4_DC_EVT_OVER_TEMP", "Over Temp")), //
		RESERVED_8(new BitPoint(8, "S160_MODULE4_DC_EVT_RESERVED_8", "Reserved 8")), //
		RESERVED_9(new BitPoint(9, "S160_MODULE4_DC_EVT_RESERVED_9", "Reserved 9")), //
		RESERVED_10(new BitPoint(10, "S160_MODULE4_DC_EVT_RESERVED_10", "Reserved 10")), //
		RESERVED_11(new BitPoint(11, "S160_MODULE4_DC_EVT_RESERVED_11", "Reserved 11")), //
		BLOWN_FUSE(new BitPoint(12, "S160_MODULE4_DC_EVT_BLOWN_FUSE", "Blown Fuse")), //
		UNDER_TEMP(new BitPoint(13, "S160_MODULE4_DC_EVT_UNDER_TEMP", "Under Temp")), //
		MEMORY_LOSS(new BitPoint(14, "S160_MODULE4_DC_EVT_MEMORY_LOSS", "Memory Loss")), //
		ARC_DETECTION(new BitPoint(15, "S160_MODULE4_DC_EVT_ARC_DETECTION", "Arc Detection")), //
		RESERVED_16(new BitPoint(16, "S160_MODULE4_DC_EVT_RESERVED_16", "Reserved 16")), //
		RESERVED_17(new BitPoint(17, "S160_MODULE4_DC_EVT_RESERVED_17", "Reserved 17")), //
		RESERVED_18(new BitPoint(18, "S160_MODULE4_DC_EVT_RESERVED_18", "Reserved 18")), //
		RESERVED_19(new BitPoint(19, "S160_MODULE4_DC_EVT_RESERVED_19", "Reserved 19")), //
		TEST_FAILED(new BitPoint(20, "S160_MODULE4_DC_EVT_TEST_FAILED", "Test Failed")), //
		INPUT_UNDER_VOLTAGE(new BitPoint(21, "S160_MODULE4_DC_EVT_INPUT_UNDER_VOLTAGE", "Input Under Voltage")), //
		INPUT_OVER_CURRENT(new BitPoint(22, "S160_MODULE4_DC_EVT_INPUT_OVER_CURRENT", "Input Over Current"));

		private final BitPoint point;

		private S160_Module4_DCEvt(BitPoint point) {
			this.point = point;
		}
	...
	public static enum S213 implements SunSpecPoint {
		A(new ValuePoint("S213_A", "Amps", //
				"Total AC Current", //
				ValuePoint.Type.FLOAT32, true /* mandatory? */, AccessMode.READ_ONLY, Unit.AMPERE)), //
		APH_A(new ValuePoint("S213_APH_A", "Amps PhaseA", //
				"Phase A Current", //
				ValuePoint.Type.FLOAT32, true /* mandatory? */, AccessMode.READ_ONLY, Unit.AMPERE)), //
		APH_B(new ValuePoint("S213_APH_B", "Amps PhaseB", //
				"Phase B Current", //
				ValuePoint.Type.FLOAT32, true /* mandatory? */, AccessMode.READ_ONLY, Unit.AMPERE)), //
		APH_C(new ValuePoint("S213_APH_C", "Amps PhaseC", //
				"Phase C Current", //
				ValuePoint.Type.FLOAT32, true /* mandatory? */, AccessMode.READ_ONLY, Unit.AMPERE)), //
		PH_V(new ValuePoint("S213_PH_V", "Voltage LN", //
				"Line to Neutral AC Voltage (average of active phases)", //
				ValuePoint.Type.FLOAT32, true /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT)), //
		PH_VPH_A(new ValuePoint("S213_PH_VPH_A", "Phase Voltage AN", //
				"Phase Voltage AN", //
				ValuePoint.Type.FLOAT32, true /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT)), //
		PH_VPH_B(new ValuePoint("S213_PH_VPH_B", "Phase Voltage BN", //
				"Phase Voltage BN", //
				ValuePoint.Type.FLOAT32, true /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT)), //
		PH_VPH_C(new ValuePoint("S213_PH_VPH_C", "Phase Voltage CN", //
				"Phase Voltage CN", //
				ValuePoint.Type.FLOAT32, true /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT)), //
		PPV(new ValuePoint("S213_PPV", "Voltage LL", //
				"Line to Line AC Voltage (average of active phases)", //
				ValuePoint.Type.FLOAT32, true /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT)), //
		P_P_VPH_A_B(new ValuePoint("S213_P_P_VPH_A_B", "Phase Voltage AB", //
				"Phase Voltage AB", //
				ValuePoint.Type.FLOAT32, true /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT)), //
		P_P_VPH_B_C(new ValuePoint("S213_P_P_VPH_B_C", "Phase Voltage BC", //
				"Phase Voltage BC", //
				ValuePoint.Type.FLOAT32, true /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT)), //
		P_P_VPH_C_A(new ValuePoint("S213_P_P_VPH_C_A", "Phase Voltage CA", //
				"Phase Voltage CA", //
				ValuePoint.Type.FLOAT32, true /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT)), //
		HZ(new ValuePoint("S213_HZ", "Hz", //
				"Frequency", //
				ValuePoint.Type.FLOAT32, true /* mandatory? */, AccessMode.READ_ONLY, Unit.HERTZ)), //
		W(new ValuePoint("S213_W", "Watts", //
				"Total Real Power", //
				ValuePoint.Type.FLOAT32, true /* mandatory? */, AccessMode.READ_ONLY, Unit.WATT)), //
		WPH_A(new ValuePoint("S213_WPH_A", "Watts phase A", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.WATT)), //
		WPH_B(new ValuePoint("S213_WPH_B", "Watts phase B", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.WATT)), //
		WPH_C(new ValuePoint("S213_WPH_C", "Watts phase C", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.WATT)), //
		VA(new ValuePoint("S213_VA", "VA", //
				"AC Apparent Power", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE)), //
		V_APH_A(new ValuePoint("S213_V_APH_A", "VA phase A", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE)), //
		V_APH_B(new ValuePoint("S213_V_APH_B", "VA phase B", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE)), //
		V_APH_C(new ValuePoint("S213_V_APH_C", "VA phase C", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE)), //
		VAR(new ValuePoint("S213_VAR", "VAR", //
				"Reactive Power", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_REACTIVE)), //
		V_A_RPH_A(new ValuePoint("S213_V_A_RPH_A", "VAR phase A", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_REACTIVE)), //
		V_A_RPH_B(new ValuePoint("S213_V_A_RPH_B", "VAR phase B", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_REACTIVE)), //
		V_A_RPH_C(new ValuePoint("S213_V_A_RPH_C", "VAR phase C", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_REACTIVE)), //
		PF(new ValuePoint("S213_PF", "PF", //
				"Power Factor", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.NONE)), //
		P_FPH_A(new ValuePoint("S213_P_FPH_A", "PF phase A", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.NONE)), //
		P_FPH_B(new ValuePoint("S213_P_FPH_B", "PF phase B", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.NONE)), //
		P_FPH_C(new ValuePoint("S213_P_FPH_C", "PF phase C", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.NONE)), //
		TOT_WH_EXP(new ValuePoint("S213_TOT_WH_EXP", "Total Watt-hours Exported", //
				"Total Real Energy Exported", //
				ValuePoint.Type.FLOAT32, true /* mandatory? */, AccessMode.READ_ONLY, Unit.CUMULATED_WATT_HOURS)), //
		TOT_WH_EXP_PH_A(new ValuePoint("S213_TOT_WH_EXP_PH_A", "Total Watt-hours Exported phase A", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.CUMULATED_WATT_HOURS)), //
		TOT_WH_EXP_PH_B(new ValuePoint("S213_TOT_WH_EXP_PH_B", "Total Watt-hours Exported phase B", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.CUMULATED_WATT_HOURS)), //
		TOT_WH_EXP_PH_C(new ValuePoint("S213_TOT_WH_EXP_PH_C", "Total Watt-hours Exported phase C", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.CUMULATED_WATT_HOURS)), //
		TOT_WH_IMP(new ValuePoint("S213_TOT_WH_IMP", "Total Watt-hours Imported", //
				"Total Real Energy Imported", //
				ValuePoint.Type.FLOAT32, true /* mandatory? */, AccessMode.READ_ONLY, Unit.CUMULATED_WATT_HOURS)), //
		TOT_WH_IMP_PH_A(new ValuePoint("S213_TOT_WH_IMP_PH_A", "Total Watt-hours Imported phase A", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.CUMULATED_WATT_HOURS)), //
		TOT_WH_IMP_PH_B(new ValuePoint("S213_TOT_WH_IMP_PH_B", "Total Watt-hours Imported phase B", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.CUMULATED_WATT_HOURS)), //
		TOT_WH_IMP_PH_C(new ValuePoint("S213_TOT_WH_IMP_PH_C", "Total Watt-hours Imported phase C", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.CUMULATED_WATT_HOURS)), //
		TOT_V_AH_EXP(new ValuePoint("S213_TOT_V_AH_EXP", "Total VA-hours Exported", //
				"Total Apparent Energy Exported", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_HOURS)), //
		TOT_V_AH_EXP_PH_A(new ValuePoint("S213_TOT_V_AH_EXP_PH_A", "Total VA-hours Exported phase A", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_HOURS)), //
		TOT_V_AH_EXP_PH_B(new ValuePoint("S213_TOT_V_AH_EXP_PH_B", "Total VA-hours Exported phase B", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_HOURS)), //
		TOT_V_AH_EXP_PH_C(new ValuePoint("S213_TOT_V_AH_EXP_PH_C", "Total VA-hours Exported phase C", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_HOURS)), //
		TOT_V_AH_IMP(new ValuePoint("S213_TOT_V_AH_IMP", "Total VA-hours Imported", //
				"Total Apparent Energy Imported", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_HOURS)), //
		TOT_V_AH_IMP_PH_A(new ValuePoint("S213_TOT_V_AH_IMP_PH_A", "Total VA-hours Imported phase A", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_HOURS)), //
		TOT_V_AH_IMP_PH_B(new ValuePoint("S213_TOT_V_AH_IMP_PH_B", "Total VA-hours Imported phase B", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_HOURS)), //
		TOT_V_AH_IMP_PH_C(new ValuePoint("S213_TOT_V_AH_IMP_PH_C", "Total VA-hours Imported phase C", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_HOURS)), //
		TOT_V_ARH_IMP_Q1(new ValuePoint("S213_TOT_V_ARH_IMP_Q1", "Total VAR-hours Imported Q1", //
				"Total Reactive Energy Imported Quadrant 1", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_REACTIVE_HOURS)), //
		TOT_V_ARH_IMP_Q1PH_A(new ValuePoint("S213_TOT_V_ARH_IMP_Q1PH_A", "Total VAr-hours Imported Q1 phase A", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_REACTIVE_HOURS)), //
		TOT_V_ARH_IMP_Q1PH_B(new ValuePoint("S213_TOT_V_ARH_IMP_Q1PH_B", "Total VAr-hours Imported Q1 phase B", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_REACTIVE_HOURS)), //
		TOT_V_ARH_IMP_Q1PH_C(new ValuePoint("S213_TOT_V_ARH_IMP_Q1PH_C", "Total VAr-hours Imported Q1 phase C", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_REACTIVE_HOURS)), //
		TOT_V_ARH_IMP_Q2(new ValuePoint("S213_TOT_V_ARH_IMP_Q2", "Total VAr-hours Imported Q2", //
				"Total Reactive Power Imported Quadrant 2", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_REACTIVE_HOURS)), //
		TOT_V_ARH_IMP_Q2PH_A(new ValuePoint("S213_TOT_V_ARH_IMP_Q2PH_A", "Total VAr-hours Imported Q2 phase A", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_REACTIVE_HOURS)), //
		TOT_V_ARH_IMP_Q2PH_B(new ValuePoint("S213_TOT_V_ARH_IMP_Q2PH_B", "Total VAr-hours Imported Q2 phase B", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_REACTIVE_HOURS)), //
		TOT_V_ARH_IMP_Q2PH_C(new ValuePoint("S213_TOT_V_ARH_IMP_Q2PH_C", "Total VAr-hours Imported Q2 phase C", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_REACTIVE_HOURS)), //
		TOT_V_ARH_EXP_Q3(new ValuePoint("S213_TOT_V_ARH_EXP_Q3", "Total VAr-hours Exported Q3", //
				"Total Reactive Power Exported Quadrant 3", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_REACTIVE_HOURS)), //
		TOT_V_ARH_EXP_Q3PH_A(new ValuePoint("S213_TOT_V_ARH_EXP_Q3PH_A", "Total VAr-hours Exported Q3 phase A", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_REACTIVE_HOURS)), //
		TOT_V_ARH_EXP_Q3PH_B(new ValuePoint("S213_TOT_V_ARH_EXP_Q3PH_B", "Total VAr-hours Exported Q3 phase B", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_REACTIVE_HOURS)), //
		TOT_V_ARH_EXP_Q3PH_C(new ValuePoint("S213_TOT_V_ARH_EXP_Q3PH_C", "Total VAr-hours Exported Q3 phase C", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_REACTIVE_HOURS)), //
		TOT_V_ARH_EXP_Q4(new ValuePoint("S213_TOT_V_ARH_EXP_Q4", "Total VAr-hours Exported Q4", //
				"Total Reactive Power Exported Quadrant 4", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_REACTIVE_HOURS)), //
		TOT_V_ARH_EXP_Q4PH_A(new ValuePoint("S213_TOT_V_ARH_EXP_Q4PH_A", "Total VAr-hours Exported Q4 Imported phase A", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_REACTIVE_HOURS)), //
		TOT_V_ARH_EXP_Q4PH_B(new ValuePoint("S213_TOT_V_ARH_EXP_Q4PH_B", "Total VAr-hours Exported Q4 Imported phase B", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_REACTIVE_HOURS)), //
		TOT_V_ARH_EXP_Q4PH_C(new ValuePoint("S213_TOT_V_ARH_EXP_Q4PH_C", "Total VAr-hours Exported Q4 Imported phase C", "", //
				ValuePoint.Type.FLOAT32, false /* mandatory? */, AccessMode.READ_ONLY, Unit.VOLT_AMPERE_REACTIVE_HOURS)), //
		EVT(new BitFieldPoint("S213_EVT", "Events", //
				"Meter Event Flags", //
				BitFieldPoint.Type.BITFIELD32, true /* mandatory? */, AccessMode.READ_ONLY, S213_Evt.values()));
